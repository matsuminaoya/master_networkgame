...
names = ["5_both_null_reset_t10_g10000_r100_w50_b1_fixed",] #TODO:
...
for name in names:
    Graph_avr_tc_tl_tf(csv="D:/master/src6/5_both_null_reset_t10_g10000_r100_w50_b1_fixed.csv", name=name) #TODO: