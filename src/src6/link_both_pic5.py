...
names = ["5_anan_both_null_noreset_t10_g10000_r100_w5000_b1",] #TODO:
...
for name in names:
    Graph_avr_tc_tl_tf("D:/master/src6/ouchi/5_anan_both_full_noreset_t10_g10000_r100_w5000_b1.csv", name=name) #TODO: