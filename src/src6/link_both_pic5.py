...
names = ["5_both_null_reset_t10_g10000_r100_w5000_b1",] #TODO:
...
for name in names:
    Graph_avr_tc_tl_tf(csv="D:/master/src6/5_both_null_reset_t10_g10000_r100_w5000_b1.csv", name=name) #TODO: