...
names = ["5_oror_leave_full_noreset_t10_g10000_r100_w5000_b1.csv",] #TODO:
...
for name in names:
    Graph_avr_tc_tf(csv="D:/master/src6/ouchi/5_oror_leave_full_noreset_t10_g10000_r100_w5000_b1.csv", name=name) #TODO: