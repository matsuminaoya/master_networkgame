...
void part1_01() {
  ...
  FILE *csv_file =
      fopen("3_keepd_01_form_or_t1_g10000_r100_w50000_b1.csv", "w");
...
void part1_03() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_03_form_or_t1_g10000_r100_w50000_b1.csv", "w");

  init_genrand((unsigned long)time(NULL));  // 乱数

  float density = 0.3f;  // [0.0, 1.0] 初期ネットワーク密度 // TODO:
...
void part1_05() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_05_form_or_t1_g10000_r100_w50000_b1.csv", "w");
...
void part1_07() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_07_form_or_t1_g10000_r100_w50000_b1.csv", "w");

  init_genrand((unsigned long)time(NULL));  // 乱数

  float density = 0.7f;  // [0.0, 1.0] 初期ネットワーク密度 // TODO:
...
void part1_09() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_09_form_or_t1_g10000_r100_w50000_b1.csv", "w");

  init_genrand((unsigned long)time(NULL));  // 乱数

  float density = 0.9f;  // [0.0, 1.0] 初期ネットワーク密度 // TODO:
...
void part2_01() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_01_form_or_t1_g10000_r100_w10000_b1.csv", "w");
...
void part2_03() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_03_form_or_t1_g10000_r100_w10000_b1.csv", "w");
...
void part2_05() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_05_form_or_t1_g10000_r100_w10000_b1.csv", "w");
...
void part2_07() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_07_form_or_t1_g10000_r100_w10000_b1.csv", "w");
...
void part2_09() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_09_form_or_t1_g10000_r100_w10000_b1.csv", "w");
...
void part3_01() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_01_leave_or_t1_g10000_r100_w50000_b1.csv", "w");
...
void part3_03() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_03_leave_or_t1_g10000_r100_w50000_b1.csv", "w");
...
void part3_05() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_05_leave_or_t1_g10000_r100_w50000_b1.csv", "w");
...
void part3_07() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_07_leave_or_t1_g10000_r100_w50000_b1.csv", "w");
...
void part3_09() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_09_leave_or_t1_g10000_r100_w50000_b1.csv", "w");
...
void part4_01() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_01_leave_or_t1_g10000_r100_w10000_b1.csv", "w");
...
void part4_03() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_03_leave_or_t1_g10000_r100_w10000_b1.csv", "w");
...
void part4_05() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_05_leave_or_t1_g10000_r100_w10000_b1.csv", "w");
...
void part4_07() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_07_leave_or_t1_g10000_r100_w10000_b1.csv", "w");
...
void part4_09() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_09_leave_or_t1_g10000_r100_w10000_b1.csv", "w");
