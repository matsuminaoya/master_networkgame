...
void part1() {
  ...
  FILE *csv_file =
      fopen("7_both_null_noreset_t10_g10000_r100_w5000_b1.csv", "w");
...
void part2() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("7_form_null_noreset_t10_g10000_r100_w5000_b1.csv", "w");
...
void part3() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("7_leave_full_noreset_t10_g10000_r100_w5000_b1.csv", "w");
