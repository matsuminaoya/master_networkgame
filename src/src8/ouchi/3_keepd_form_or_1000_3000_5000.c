...
void part11() {
  ...
  FILE *csv_file =
      fopen("3_keepd_01_form_or_t10_g10000_r100_w1000_b1.csv", "w");
...
void part13() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_03_form_or_t10_g10000_r100_w1000_b1.csv", "w");
...
void part15() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_05_form_or_t10_g10000_r100_w1000_b1.csv", "w");
...
void part17() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_07_form_or_t10_g10000_r100_w1000_b1.csv", "w");
...
void part19() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_09_form_or_t10_g10000_r100_w1000_b1.csv", "w");
...
void part33() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_03_form_or_t10_g10000_r100_w3000_b1.csv", "w");
...
void part35() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_05_form_or_t10_g10000_r100_w3000_b1.csv", "w");
...
void part37() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_07_form_or_t10_g10000_r100_w3000_b1.csv", "w");
...
void part39() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_09_form_or_t10_g10000_r100_w3000_b1.csv", "w");
...
void part53() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_03_form_or_t10_g10000_r100_w5000_b1.csv", "w");
...
void part55() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_05_form_or_t10_g10000_r100_w5000_b1.csv", "w");
...
void part57() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_07_form_or_t10_g10000_r100_w5000_b1.csv", "w");
...
void part59() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_09_form_or_t10_g10000_r100_w5000_b1.csv", "w");
