...
void part01() {
  ...
  FILE *csv_file =
      fopen("3_keepd_01_form_an_t10_g10000_r100_w1000_b1.csv", "w");
...
void part03() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_03_form_an_t10_g10000_r100_w1000_b1.csv", "w");
...
void part05() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_05_form_an_t10_g10000_r100_w1000_b1.csv", "w");
...
void part07() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_07_form_an_t10_g10000_r100_w1000_b1.csv", "w");
...
void part09() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("3_keepd_09_form_an_t10_g10000_r100_w1000_b1.csv", "w");
