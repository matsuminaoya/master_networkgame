...
// 6_anan_both_null_noreset_t10_g10000_r100_w5000_b1
void part1() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("7_anan_both_null_noreset_t10_g10000_r100_w5000_b1.csv", "w");
...
//         for (int i = 0; i < NUM_AGENTS; i++) {
//           if (count_game_ge[i] > 0) {
//             coop_game_rate[i] = (float)count_coop_game_ge[i] /
//             count_game_ge[i];
//           } else {
//             coop_game_rate[i] =
//                 0.0f;  //
//                 ゲーム未参加者は0とする,今回は分母が0になることはなし
//           }
//         }  // 協力ゲーム率計算終了
...
// 6_anan_leave_full_noreset_t10_g10000_r100_w5000_b1
void part3() {
  // CSVファイルを出力するための準備 TODO:
  FILE *csv_file =
      fopen("7_anan_leave_full_noreset_t10_g10000_r100_w5000_b1.csv", "w");
