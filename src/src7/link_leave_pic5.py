...
names = ["6_leave_full_noreset_t10_g10000_r100_w5000_b1",] #TODO:
...
for name in names:
    Graph_avr_tc_tf(csv="D:/master/src7/ouchi/6_leave_full_noreset_t10_g10000_r100_w5000_b1.csv", name=name) #TODO: